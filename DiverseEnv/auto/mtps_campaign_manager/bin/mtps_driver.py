...
class Driver:
    def __init__(self, base_path, base_path2, script_path, scenario_name, route_name,
                 agent_mode, experiment_mode, num_run, result_dir, device, timeout, mitigation_mode):
    ...
    def run_experiment(self):
        ...
        # the launch sim, disabled, launch by mitigation script
        ...
        agent_settings += " --scenarios={}/{}/leaderboard/data/{}.json".format(self.base_path, self.base_path2,
                                                                               self.scenario_name) + " "
        agent_settings += " --agent=image_agent_rl.py" + " "
        ...
        agent_settings += " --mitigation_mode={}".format(self.mitigation_mode) + " "
        agent_settings += "--mitigation_risk_save={} ".format(out_dir + "/{}_data".format(self.scenario_name))
...
def main():
    ...
    dfi = Driver(params.base_path, params.base_path2, params.script_path, params.scenario_name, params.route_name,
                 params.agent_mode, "param_sweep", int(params.num_run), params.result_dir, params.device, params.timeout, params.mitigation_mode)
    dfi.run_experiment()
