...
from env_interactor import CarlaRLEnv
...
class CarlaRIP(object):
    def __init__(self):
        self.config_dict = {
            ...
            'traj_pickle_stored': "/<PATH_TO_FILE>/DSN2024/DiverseEnv/carladataset/carla-sim/safety-critical-simdata/route_highway.xml_fi_lead_cutin.json.pkl",
            'inference_model_path': "/<PATH_TO_FILE>/DSN2024/ReachML/reachml/checkpoints/final_lead_ghost_cutin_cvctr_3s_train_2022-05-15-16-17-17.pth",
            'inference_config_path': "/<PATH_TO_FILE>/DSN2024/ReachML/reachml/data/train_test_sim_lite/route_highway.xml_fi_ghost_cutin.json.pkl/model_unc/data_realtime_trail0_3s/realtime_trail0_3s_data_config.json",
            'qvalue_net_rl': 1e-6,
            'weight_decay': 0.9999,
            'reward_decay': 0.99,
            'tau': 0.01,
            ...
            'action_space': 2,
            'base_path': '/<PATH_TO_FILE>/DSN2024/DiverseEnv/auto',
    ...
    def inference_single_episode_rl_mitigation(self, episode, skip_first_seconds,
        ...
        self.rip_ckpts = ["/<PATH_TO_FILE>/DSN2024/Oatomobile/model-400-1.pt",
                          "/<PATH_TO_FILE>/DSN2024/Oatomobile/model-400-2.pt",
                          "/<PATH_TO_FILE>/DSN2024/Oatomobile/model-400-3.pt",
                          "/<PATH_TO_FILE>/DSN2024/Oatomobile/model-400-4.pt"]
