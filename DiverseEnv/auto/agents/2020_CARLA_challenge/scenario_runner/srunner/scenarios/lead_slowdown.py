...
class LeadSlowDown(BasicScenario):
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        self.scene_config = {
            ...
            "first_vehicle_speed": 10,
            "other_actor_max_brake": 1.0,
            "event_trigger_distance": 35
        }
    ...
    def _create_behavior(self):
        ...
        driving_to_next_intersection_second.add_child(InTriggerDistanceToVehicle(self.other_actors[0],
                                                                                 ...
                                                                                 name="Distance"))
        driving_to_next_intersection_second.add_child(StopVehicle(self.other_actors[0], self.scene_config["other_actor_max_brake"]))
