...
class GhostCutInCurved(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False, debug_mode=False, criteria_enable=True,
        ...
        super(GhostCutInCurved, self).__init__("FollowVehicle",
                                         ego_vehicles,
                                         config,
                                         world,
                                         debug_mode,
    ...
    def _initialize_actors(self, config):
        ...
        self._other_actor_transform = carla.Transform(
            carla.Location(first_vehicle_waypoint.transform.location.x - 5,
                           first_vehicle_waypoint.transform.location.y - 3.2,
                           first_vehicle_waypoint.transform.location.z + 0.1),
            first_vehicle_waypoint.transform.rotation)
        first_vehicle_transform = carla.Transform(
            carla.Location(self._other_actor_transform.location.x - 5,
                           self._other_actor_transform.location.y - 3.2,
