...
class LeadCutInCurved(BasicScenario):
    """
    ...
    def __init__(self, world, ego_vehicles, config, randomize=False,
        ...
        self.scene_config = {
            "first_vehicle_location": 22,
            "first_vehicle_speed": 16,
            "event_trigger_distance": 8,
            "distance_lane_change": 11,
            "speed_lane_change": 10
        }
        ...
        super(LeadCutInCurved, self).__init__("FollowVehicle",
                                        ego_vehicles,
                                        config,
                                        world,
                                        debug_mode,
