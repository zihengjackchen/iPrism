...
from srunner.scenarios.lead_slowdown_collision import LeadSlowDownCollision
from srunner.scenarios.lead_slowdown_further import LeadSlowDownFurther
from srunner.scenarios.ghost_cutin import GhostCutIn
from srunner.scenarios.ghost_cutin_curved import GhostCutInCurved
from srunner.scenarios.lead_cutin_curved import LeadCutInCurved
from srunner.scenarios.front_accident import FrontAccident
from srunner.scenarios.lead_cutin import LeadCutIn
from srunner.scenarios.lead_cutin_collision import LeadCutInCollision
from srunner.scenarios.lead_cutin_further import LeadCutInFurther
from srunner.scenarios.opposite_drift_in import OppositeDriftIn
from srunner.scenarios.rear_ending import RearEnding
from srunner.scenarios.follow_leading_vehicle import FollowLeadingVehicleWithObstacle
# from srunner.scenarios.follow_leading_vehicle import EncouterObstacle
...
NUMBER_CLASS_TRANSLATION = {
    ...
    "Scenario21": GhostCutInCurved,
    "Scenario3": FrontAccident,
    "Scenario5": LeadCutIn,
    "Scenario51": LeadCutInCurved,
    "Scenario6": OppositeDriftIn,
    "Scenario20": RearEnding,
    "Scenario10": LeadCutInCollision,
    "Scenario11": LeadSlowDownCollision,
    "Scenario12": LeadSlowDownFurther,
    "Scenario13": LeadCutInFurther,
    "Scenario14": FollowLeadingVehicleWithObstacle,
    # "Scenario15": EncouterObstacle
}
...
class FIScenario(BasicScenario):
    ...
    def __init__(self, world, config, debug_mode=0, criteria_enable=True, ego_vehicle=None):
        """
        ...
        # Should sampled_scenarios_definitions be None?
    ...
    def _update_route(self, world, config, debug_mode):
        ...
        gps_route, route = interpolate_trajectory(world, config.trajectory, hop_resolution=1)
    ...
    def _update_ego_vehicle(self, ego_vehicle):
        ...
        if ego_vehicle is None:
            ...
            ego_vehicle = CarlaDataProvider.manipulate_new_actor(ego_vehicle, 'vehicle.lincoln.mkz2017',
                                                              elevate_transform,
                                                              rolename='hero')

        spectator = CarlaDataProvider.get_world().get_spectator()
        ego_trans = ego_vehicle.get_transform()
        print(ego_trans.location, ego_trans.rotation)
