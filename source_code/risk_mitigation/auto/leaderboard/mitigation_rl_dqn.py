...
class CarlaLBCDQN(object):
    def __init__(self):
        ...
        #     'scenarios': '/media/sheng/data4/projects/DiverseEnv/auto/agents/2020_CARLA_challenge/leaderboard/data/fi_lead_slowdown.json',
        #     'repetitions': 1,
        ...
        self.config_dict = {
            ...
            'sim_data_save': '/media/sheng/data4/projects/DiverseEnv/auto/sim_data_collection',
            'routes': '/media/sheng/data4/projects/DiverseEnv/auto/agents/2020_CARLA_challenge/leaderboard/data/routes_fi/route_highway.xml',
            'scenarios': '/media/sheng/data4/projects/DiverseEnv/auto/agents/2020_CARLA_challenge/leaderboard/data/fi_rear_ending.json',
            'repetitions': 1,
            'agent': 'image_agent_rl.py',
            'agent_config': '/media/sheng/data4/projects/DiverseEnv/auto/agents/2020_CARLA_challenge/epoch24.ckpt',
            'track': 'SENSORS',
            ...
            'traj_pickle_stored': "/home/sheng/projects/DiverseEnv/carladataset/carla-sim/safety-critical-simdata/route_highway.xml_fi_ghost_cutin.json.pkl",
            ...
            # read from inference
            # 'ram_shared_path': '/media/sheng/data9/home/sheng/DiverseAV/auto/ram_shared/dqn_sti_online/'
        ...
        while not done:
            ...
            if rewards[0] is not None and rewards[1] is not None:
                ...
                if timestamp.elapsed_seconds > skip_mitigation_seconds:
                    ...
                    print("SMC time now:", time.now() - start)
...
def main():
    ...
    #                                          load_checkpoint=-1)
    dqn_lbc.inference_loop_standalone_process(total_episodes=1, mitigation="smart", mitigation_configs={
        "skip_mitigation_seconds": 5,
        "skip_first_seconds": 4
    })
