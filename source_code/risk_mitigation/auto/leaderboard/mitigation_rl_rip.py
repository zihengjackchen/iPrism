...
class CarlaRIP(object):
    def __init__(self):
        self.config_dict = {
            ...
            'inference_model_path': "/media/sheng/data4/projects/ReachML/reachml/checkpoints/final_ps_ghost_cutin_cvctr_3s_2022-05-02-15-51-19.pth",
            ...
            'action_space': 2,
            'base_path': '/media/sheng/data4/projects/DiverseEnv/auto',
            'ram_shared_path': '/media/sheng/data4/projects/DiverseEnv/auto/ram_shared/dqn'
        }
    ...
    def inference_single_episode_rl_mitigation(self, episode, skip_first_seconds,
        ...
        self.rip_ckpts = ["/media/sheng/data9/home/sheng/Oatomobile/model-400-1.pt",
                          "/media/sheng/data9/home/sheng/Oatomobile/model-400-2.pt",
                          "/media/sheng/data9/home/sheng/Oatomobile/model-400-3.pt",
                          "/media/sheng/data9/home/sheng/Oatomobile/model-400-4.pt"]
        ...
        while not done:
            ...
            if rewards[0] is not None and rewards[1] is not None:
                ...
                print("Current risk:", rewards[0])
                print("Current reward:", rewards[1])
                print("Current mitigation activation:", 0)
                print("#############################")
                risk_list.append(rewards[0])
                time_list.append(int(timestamp.elapsed_seconds * 1e9))
                if not np.isnan(rewards[1]):
