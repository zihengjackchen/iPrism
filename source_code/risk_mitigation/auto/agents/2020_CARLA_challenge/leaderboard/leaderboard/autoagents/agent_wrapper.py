...
class AgentWrapper(object):
    ...
    def __call2__(self, policy_action):
        return self._agent.__call2__(policy_action)

    def setup_second_agent(self, agent, duplicate=False):
        """
        ...
        if self._agent:
            ...
            self._agent2.sensor_interface.set_dual_agent(True, duplicate)
        else:
